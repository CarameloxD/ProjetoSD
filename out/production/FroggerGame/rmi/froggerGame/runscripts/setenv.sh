...
#export CURRENT_IDE=¢{NETBEANS}2
export USERNAME=rui

#@REM ==== JAVA NAMING STUFF ====
export JAVAPROJ_NAME=ProjetoSD
export JAVAPROJ=C:\Users\joaop\IdeaProjects\IntelliJProjects\ProjetoSD
...
export CLIENT_CLASS_PREFIX=froggerGame
export SERVER_CLASS_PREFIX=froggerGame
