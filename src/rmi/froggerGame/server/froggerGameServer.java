...
public class froggerGameServer {
    ...
    public static void main(String[] args) {
        if (args != null && args.length < 3) {
            System.err.println("usage: java [options] froggerGameServer <rmi_registry_ip> <rmi_registry_port> <service_name>");
            System.exit(-1);
        } else {
            //1. ============ Create Servant ============
            froggerGameServer hws = new froggerGameServer(args);
     ...
     * @param args
     */
    public froggerGameServer(String args[]) {
        try {
            //============ List and Set args ============
    ...
    private void rebindService() {
        try {
            ...
            if (registry != null) {
                //============ Create Servant ============
                froggerGameFactoryRI= new froggerGameFactoryImpl();
                ...
                registry.rebind(serviceUrl, froggerGameFactoryRI);
